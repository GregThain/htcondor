...
if(NOT WINDOWS)
    ...
    if (WANT_PYTHON3_BINDINGS AND PYTHON3_INSTALL_DIR)
        ...
        set(PYTHON_QUERY_PART_05 "print(f'sys_prefix is _{sys.prefix}_');")
        set(PYTHON_QUERY_PART_06 "print(s.get_path('include'));")
        set(PYTHON_QUERY_PART_06 "print(s.get_path('platlib'));")
